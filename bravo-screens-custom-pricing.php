 ...
 */
define('BRAVO_SCREENS_CUSTOM_PRICING_VERSION', '4.2.0');
...
include_once ( plugin_dir_path( __FILE__ ) . 'includes/category-description/bscp-fifth-description-field.php' );
include_once ( plugin_dir_path( __FILE__ ) . 'includes/category-description/bscp-sixth-description-field.php' );
include_once ( plugin_dir_path( __FILE__ ) . 'includes/category-description/bscp-seventh-description-field.php' );
